import 'package:gosari_app/common/constant/app_colors.dart';
import 'package:flutter/material.dart';

export 'package:gosari_app/common/constant/app_colors.dart';
...
abstract class AbstractThemeColors {
  ...
  Color get appBg => const Color.fromARGB(255, 255, 255, 255);
  ...
  Color get mosttext => AppColors.green;
  ...
  Color get greyButtonBackground => AppColors.darkGrey;
}
